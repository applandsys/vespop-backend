const {getTotalCustomer, getTotalOrder, getTotalOrderAmount, getTodayCustomer, getTodayOrderAmount, getTodayOrderTotal} = require("@/modules/reports/model/adminStatsModel");
